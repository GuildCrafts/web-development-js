...
__FEEDBACK:__ should we supply a link to the specific RESTFUL/CRUD pattern we want them to follow?
...
__FEEDBACK:__ we might want to say specifically how to show that they were code reviewed. If they dont show that on Github I cannot confirm this spec was met. 

- [ ] All code submissions are peer reviewed via GitHub PR by at least one other member of the team

__FEEDBACK:__ this is crazy hard to confirm in a completeness review. I think we should remove or change this spec. 
